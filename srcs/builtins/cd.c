...
/*   Updated: 2025/03/11 17:34:45 by ngaurama         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_cd(t_shell *shell)
{
	...
	dir = shell->arguments->next ? shell->arguments->next->value : getenv("HOME");
	if (!dir)
	{
		...
		const char *value)
{
	...
	key_value = malloc(ft_strlen(key) + ft_strlen(value) + 2);
	if (!key_value)
		return ;
